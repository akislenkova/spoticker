-- Narrow CPU regex patterns to D-series only.
-- The previous [A-Za-z]\d+ prefix matched E/F/M-series too, producing 50k+ rows
-- and making the scraper time out. D-series covers all three architectures well.
