...
export default function MatrixLegend({ awsMetric }: { awsMetric: AwsMetric }) {
  return (
    <div className="grid gap-3 lg:grid-cols-2 xl:grid-cols-4 text-xs">
      ...
      <Panel>
        <div className="flex items-center gap-2">
          <span className="font-mono font-semibold text-[#7aab8e] tracking-wider">GCP</span>
          <span className="rounded border border-[rgba(160,100,255,0.2)] bg-[rgba(160,100,255,0.07)] px-1.5 py-0.5 font-mono text-[9px] font-medium uppercase tracking-widest text-[#a064ff]">
            Preemptible
          </span>
        </div>
        <p className="mt-2 font-mono text-[#80b898] leading-relaxed text-[11px]">
